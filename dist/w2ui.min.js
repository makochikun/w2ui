/* w2ui 2.0.x (nightly) (6/27/2023, 8:11:34 PM) (c) http://w2ui.com, vitmalina@gmail.com */
        ...
        `,p=new Date(e+`/${r}/1`);t=(p=new Date(p.getTime()+432e5)).getDay();"M"==w2utils.settings.weekStarts&&a--,0<t&&(p=new Date(p.getTime()-864e5*a));for(let e=0;e<42;e++){var f=[],m=`${p.getFullYear()}/${p.getMonth()+1}/`+p.getDate(),g=(6===p.getDay()&&f.push("w2ui-saturday"),0===p.getDay()&&f.push("w2ui-sunday"),p.getMonth()+1!==r&&f.push("outside"),m==this.today&&f.push("w2ui-today"),p.getDate());let e="",t="",i,s;s="datetime"===l.type?(i=w2utils.formatDateTime(m,l.format),w2utils.formatDate(m,w2utils.settings.dateFormat)):i=w2utils.formatDate(m,l.format),l.colored&&void 0!==l.colored[s]&&(m=l.colored[s].split("|"),t="background-color: "+m[0]+";",e="color: "+m[1]+";"),c+=`<div class="w2ui-day ${this.inRange(i,l,!0)?"w2ui-date "+(s==n?"w2ui-selected":""):"w2ui-blocked"} ${f.join(" ")}"
            ...
            ${s.btnNow?`<div class="w2ui-cal-now">${w2utils.lang("Now")}</div>`:""}
                ...
                `),r.line=i)}return query(this.box).attr("name",this.name).addClass("w2ui-reset w2ui-toolbar").html(t),0<query(this.box).length&&(query(this.box)[0].style.cssText+=this.style),w2utils.bindEvents(query(this.box).find(".w2ui-tb-line .w2ui-eaction"),this),this.last.observeResize=new ResizeObserver(()=>{this.resize()}),this.last.observeResize.observe(this.box),this.refresh(),this.resize(),l.finish(),Date.now()-s}}refresh(i){var t=Date.now(),l=this.trigger("refresh",{target:null!=i?i:this.name,item:this.get(i)});if(!0!==l.isCancelled){let e;if(null==i)for(let e=0;e<this.items.length;e++){var s=this.items[e];null==s.id&&(s.id="item_"+e),this.refresh(s.id)}else{var r=this.get(i);if(null==r)return!1;if("function"!=typeof r.onRefresh||!0!==(e=this.trigger("refresh",{target:i,item:r,object:r})).isCancelled){var n=`#tb_${this.name}_item_`+w2utils.escapeId(r.id);let s=query(this.box).find(n);var a=this.getItemHTML(r);if(this.tooltipHide(i),"spacer"==r.type&&query(this.box).find(".w2ui-tb-line:nth-child("+r.line).find(".w2ui-tb-right").css("width","auto"),0===s.length){i=parseInt(this.get(i,!0))+1;let e=query(this.box).find(`#tb_${this.name}_item_`+w2utils.escapeId(this.items[i]?this.items[i].id:""));0==e.length?e=query(this.box).find(".w2ui-tb-line:nth-child("+r.line).find(".w2ui-tb-right").before(a):e.after(a),w2utils.bindEvents(query(this.box).find(n),this)}else{query(this.box).find(n).replace(query.html(a));let t=query(this.box).find(n).get(0),i=(w2utils.bindEvents(t,this),w2tooltip.get(!0));Object.keys(i).forEach(e=>{i[e].anchor==s.get(0)&&(i[e].anchor=t)})}if(["menu","menu-radio","menu-check"].includes(r.type)&&r.checked){let t=Array.isArray(r.selected)?r.selected:[r.selected];i="function"==typeof r.items?r.items(r):[...r.items];i.forEach(e=>{t.includes(e.id)?e.checked=!0:e.checked=!1}),w2menu.update(this.name+"-drop",i)}return"function"==typeof r.onRefresh&&e.finish(),l.finish(),Date.now()-t}}}}resize(){var e=Date.now(),t=this.trigger("resize",{target:this.name});if(!0!==t.isCancelled)return query(this.box).find(".w2ui-tb-line").each(e=>{var e=query(e),t=(e.find(".w2ui-scroll-left, .w2ui-scroll-right").hide(),e.find(".w2ui-scroll-wrapper").get(0)),i=e.find(".w2ui-tb-right"),s=e.get(0).getBoundingClientRect().width,i=0<i.length?i[0].offsetLeft+i[0].clientWidth:0;s<i&&(0<t.scrollLeft&&e.find(".w2ui-scroll-left").show(),s<i-t.scrollLeft)&&e.find(".w2ui-scroll-right").show()}),t.finish(),Date.now()-e}destroy(){var e=this.trigger("destroy",{target:this.name});!0!==e.isCancelled&&(0<query(this.box).find(".w2ui-scroll-wrapper  .w2ui-tb-right").length&&query(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-toolbar").html(""),query(this.box).html(""),this.last.observeResize?.disconnect(),delete w2ui[this.name],e.finish())}getItemHTML(i){let e="",t=(null!=i.caption&&null==i.text&&(i.text=i.caption),null==i.text&&(i.text=""),null==i.tooltip&&null!=i.hint&&(i.tooltip=i.hint),null==i.tooltip&&(i.tooltip=""),"function"==typeof i.get||!Array.isArray(i.items)&&"function"!=typeof i.items||(i.get=function(t){let e=i.items;return(e="function"==typeof e?i.items(i):e).find(e=>e.id==t)}),""),s="function"==typeof i.text?i.text.call(this,i):i.text;i.icon&&(t=i.icon,"function"==typeof i.icon&&(t=i.icon.call(this,i)),t=`<div class="w2ui-tb-icon">${t="<"!==String(t).slice(0,1)?`<span class="${t}" ${i.icon_style?`style="${i.icon_style}"`:""}></span>`:t}</div>`);var l=["w2ui-tb-button"];switch(i.checked&&l.push("checked"),i.disabled&&l.push("disabled"),i.hidden&&l.push("hidden"),t||l.push("no-icon"),i.type){case"color":case"text-color":"string"==typeof i.color&&("#"==i.color.slice(0,1)&&(i.color=i.color.slice(1)),[3,6,8].includes(i.color.length))&&(i.color="#"+i.color),"color"==i.type&&(s=`<span class="w2ui-tb-color-box" style="background-color: ${null!=i.color?i.color:"#fff"}"></span>
                    ...
                    >
                        ${t}
                        <div class="w2ui-tb-text" style="${i.style??""}; ${s?"":"padding-left: 0; margin-left: 23px;"}">
                            ${w2utils.lang(s)}
